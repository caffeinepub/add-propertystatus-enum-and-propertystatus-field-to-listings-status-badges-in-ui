...
const Header = memo(() => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-slate-950/80 backdrop-blur-xl border-b border-white/10">
      <div className="mx-auto px-4 sm:px-6 py-4 sm:py-5 flex items-center justify-between max-w-screen-2xl">
        {/* Logo: /assets/generated/styo-logo-tech-neon-full.dim_1200x400.png */}
        <button
          onClick={handleHomeClick}
          className="flex items-center leading-none shrink-0 bg-transparent border-0 outline-none p-0 m-0 cursor-pointer group"
          style={{ background: 'none', boxShadow: 'none' }}
        >
          <img
            src="/assets/generated/styo-logo-tech-neon-full.dim_1200x400.png"
            alt="STYO Logo"
            className="h-10 md:h-[52px] w-auto block transition-transform duration-300 group-hover:scale-105"
            loading="eager"
          />
        </button>
